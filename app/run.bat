...
start "Directory Service" cmd /c "cd directory && python directory.py"
...
start "Agent 1" cmd /c "cd agent1 && python agent1.py"

:: Start Agent 2
echo Starting Agent 2 on port 5002...
start "Agent 2" cmd /c "cd agent2 && python agent2.py"
